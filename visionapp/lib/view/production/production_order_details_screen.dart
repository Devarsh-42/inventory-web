...
//   AppBar _buildAppBar() {
//     return AppBar(
//       title: const Text('Production Orders Management'),
//       backgroundColor: const Color(0xFF1E40AF),
...
// class ProductionOrderDetailsScreen extends StatelessWidget {
//   final Order order;
...
//     final bool isEditable = !['ready', 'completed', 'shipped'].contains(order.status.toString().split('.').last);
//     final completedQuantity = isEditable ? product.completed : product.quantity;
...
//                         onPressed: product.completed > 0 
//                           ? () => _updateProductQuantity(product, product.completed - 1)
//                           : null,
...
//                         decoration: BoxDecoration(
//                           color: _getProgressColor(completedQuantity / product.quantity),
//                           borderRadius: BorderRadius.circular(12),
//                         ),
//                         child: Text(
//                           '$completedQuantity/${product.quantity}',
//                           style: const TextStyle(
//                             fontSize: 14,
//                             fontWeight: FontWeight.w600,
//                             color: Colors.white,
...
//                         onPressed: product.completed < product.quantity 
//                           ? () => _updateProductQuantity(product, product.completed + 1)
//                           : null,
...
//                 value: completedQuantity / product.quantity,
//                 backgroundColor: Colors.grey[200],
//                 valueColor: AlwaysStoppedAnimation<Color>(
//                   _getProgressColor(completedQuantity / product.quantity),
//                 ),
//                 minHeight: 8,
//               ),
//             ),
...
//   Future<void> _updateProductQuantity(ProductItem product, int newQuantity) async {
//     if (['ready', 'completed', 'shipped'].contains(order.status.toString().split('.').last)) {
//       return; // Don't allow updates for completed/ready/shipped orders
//     }

//     try {
//       await Context.read<OrdersViewModel>().updateProductQuantity(
//         orderId: order.id,
...
//     if (progress >= 1) {
//       return const Color(0xFF22C55E); // Completed
//     } else if (progress > 0) {
//       return const Color(0xFF3B82F6); // In Progress
//     }
//     return const Color(0xFF64748B); // Not Started
//   }
...
//                     _buildInfoRow('Priority:', order.priority.toString().split('.').last.toUpperCase()),
...
//             ),
//             const SizedBox(height: 12),
//             ...order.products.map(_buildProductCard).toList(),
//           ],
//         ),
//       ),
//     );
