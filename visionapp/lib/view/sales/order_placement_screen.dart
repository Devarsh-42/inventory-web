...
class Sales_AddOrderScreen extends StatefulWidget {
  final Order? orderToEdit;

  const Sales_AddOrderScreen({Key? key, this.orderToEdit}) : super(key: key);

  @override
  _Sales_AddOrderScreenState createState() => _Sales_AddOrderScreenState();
}

class _Sales_AddOrderScreenState extends State<Sales_AddOrderScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<ProductsViewModel>(context, listen: false).loadProducts(); // Changed this line
      _initializeForm();
    });
  }
  ...
  // Update _buildProductItem method
  ...
  Future<void> _showAddNewProductDialog() async {
  ...
  void _submitOrder() async {
    ...
    try {
      ...
      final productViewModel = Provider.of<ProductionViewModel>(context, listen: false);
